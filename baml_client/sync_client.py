...
class BamlStreamClient:
    ...
    def AssessHealthRisk(
        ...
        symptoms: str,patientData: str,modelEvaluations: List[types.ModelEvaluation],dataset: types.DatasetInfo,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.RiskAssessment, types.RiskAssessment]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[partial_types.RiskAssessment, types.RiskAssessment](
        raw,
    ...
    def ConsolidateFeatures(
        ...
        datasetFeatures: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.ConsolidatedFeatures, types.ConsolidatedFeatures]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[partial_types.ConsolidatedFeatures, types.ConsolidatedFeatures](
        raw,
    ...
    def EvaluateDatasetRelevance(
        ...
        symptoms: str,datasets: List[types.DatasetInfo],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[List[partial_types.DatasetInfo], List[types.DatasetInfo]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[List[partial_types.DatasetInfo], List[types.DatasetInfo]](
        raw,
    ...
    def EvaluateModels(
        ...
        dataset: types.DatasetInfo,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[List[partial_types.ModelEvaluation], List[types.ModelEvaluation]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[List[partial_types.ModelEvaluation], List[types.ModelEvaluation]](
        raw,
    ...
    def GenerateHealthReport(
        ...
        symptoms: str,assessments: List[types.RiskAssessment],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.HealthRiskReport, types.HealthRiskReport]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[partial_types.HealthRiskReport, types.HealthRiskReport](
        raw,
    ...
    def GenerateSearchQueries(
        ...
        symptoms: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.SearchQueries, types.SearchQueries]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[partial_types.SearchQueries, types.SearchQueries](
        raw,
